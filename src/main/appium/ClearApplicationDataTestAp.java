...
//            client.install(System.getProperty("user.dir")+"\\apps\\EriBank.ipa",true,false);
            ...
            loginEriBank();
            String accountAmount = client.getTextIn("NATIVE", MyProperties.instrumented ? "xpath=//*[@text='Make Payment']" : "xpath=//*[@text='makePaymentButton']", 0, MyProperties.instrumented ? "WEB" : "NATIVE", "Up", 0, 0,0,0);
